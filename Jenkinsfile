    ...
    stages {    
        ...
        stage('After Manual Restore') {
         ...
         environment{
            ...
            steps {
                ...
                bat 'node SerialChange.js MIGR-RAMDISK-DS'
                bat 'node SerialChange.js upgrade-420-mssql MIGR-RAMDISK-DS'
        ...
        CSA_DEPLOY_DISTRIBS = 'carlsource_v4.0.2'
            ...
            steps {
                ...
                bat 'node addlicence.js'
                bat 'node SerialChange.js MIGR-RAMDISK-DS'
                bat 'node SerialChange.js upgrade-402-mssql MIGR-RAMDISK-DS'
            ...
            steps {
                echo 'Starting Stage 501'  
                 ...
                 script {
                    ...
                    bat 'node addlicence.js'
                    bat 'node SerialChange.js MIGR-RAMDISK-DS'
                    bat 'node SerialChange.js upgrade-501-mssql-jboss MIGR-RAMDISK-DS'
                    bat 'node SerialChange.js upgrade-501-mssql-tomcat MIGR-RAMDISK-DS'
